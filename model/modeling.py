    ...
    def __init__(self,
        ...
        Args:
          ...
          use_one_hot_embeddings: (optional) bool. Whether to use one-hot word
            ...
            this is False.
          scope: (optional) variable scope. Defaults to "electra_if".
        ...
        if input_reprs is None:
            if input_embeddings is None:
                with tf.variable_scope(
                        (scope if untied_embeddings else "electra_if") + "/embeddings",
                        reuse=tf.AUTO_REUSE):
        ...
        with tf.variable_scope(scope, default_name="electra_if"):
